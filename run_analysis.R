...
#Rahul 10/25/2015
#Files has to be present in working directory
...
#Assignment2.Extracts only the measurements on the mean and standard deviation for each measurement. 
...
#Assignment3.Uses descriptive activity names to name the activities in the data set
